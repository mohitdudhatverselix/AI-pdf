  ...
  return (
    <>
      ...
      <div className="prices">
          ...
          </div>
          {
            data.map((item,i)=>{
              return (
                ...
                <div className="total ">
             <del className="text-black font-[Inter] text-[10px] text-center">INR {item.prevPrice}</del>
                  <h3 className="text-black font-[Inter] text-[15px] text-center pb-[7px]">INR {item.currPrice}</h3>
                </div>
              </div>
              )
            })
        ...
        <div className="cta text-black text-[15px] text-center ">
